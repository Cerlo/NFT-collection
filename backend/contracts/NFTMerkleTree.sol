...
contract NFTMerkleTree is ERC20, Ownable{
    ...
    /**
    * @notice Allows whitelisted user to mint tokens
    * 
    * @param _to Account receiver
    * @param _proof The Merkle Proof
    **/
    function mint(address _to, bytes32[] calldata _proof) external{
        require(isWhitelisted(msg.sender, _proof), "not Whitlisted");
    ...
    **/
    ...
    /**
    * @notice check if address is whitelisted or not
    * @param _account The account to check
    * @param _proof The merkle proof

    * @return bool return true if the address hasbeen whitlisted false otherwise 
    */
